...
class Command(BaseCommand):
    ...
    def write_migration_files(self, changes):
        ...
        patch_writer = patch("django.db.migrations.writer.serializer_factory", serializer.serializer_factory)
        patch_serializer = patch("django.db.migrations.serializer.serializer_factory", serializer.serializer_factory)
        with patch_writer, patch_serializer:
            directory_created = {}
